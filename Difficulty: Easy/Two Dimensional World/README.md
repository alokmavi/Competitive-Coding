<h2><a href="https://www.geeksforgeeks.org/problems/two-dimensional-world/1?page=4&category=CPP&status=unsolved&sortBy=submissions">Two Dimensional World</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><em><span style="font-size: 18px;">In CPP we can't pass 2D arrays in normal way to a function. The array has to be declared in a special way.</span></em></p>
